...
def main():
  ...
  DATA_INPUTS = 'hjxh365-2018-4-16-day-clear-full.csv'
  ...
  print('seqMat:-----------------------')
  print(seqMat)
  base.write_a_dataset_to_a_csv('hjxh365-2018-4-16-day-clear-full-seq.csv', seqMat)

#  dwtMat = dwt_single_level(seqMat,'db2','symmetric')
  dwtMat = dwt_multi_level(seqMat,'db1','symmetric',4)
  base.write_a_dataset_to_a_csv('hjxh365-2018-4-16-day-clear-full-dwt-ml4.csv', dwtMat)
