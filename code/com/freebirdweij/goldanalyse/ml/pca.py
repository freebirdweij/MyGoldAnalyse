...
def main():
  ...
  DATA_INPUTS = 'hjxh365-2018-4-16-day.csv'
  ...
  print('reconMat:-----------------------')
  print(reconMat)
  base.write_a_dataset_to_a_csv('hjxh365-2018-4-16-day-pca.csv', pcaData)
  base.write_a_dataset_to_a_csv('hjxh365-2018-4-16-day-pca-recn.csv', reconMat)
